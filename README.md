...
| [typeToSearchFn] | `(term: string) => boolean` |  `null` | no | Display typeToSearchText if that function returns true, item list is empty and select is not in loading state |
